...
const Index = () => {
  ...
  return (
    <main className="min-h-screen pt-16">
      <SEOHead 
        title={language === "de" 
          ? "Nürnberg Renegades e.V. | Flag Football 1. DFFL Liga" 
          : "Nürnberg Renegades e.V. | Flag Football 1st DFFL League"
        }
        description={language === "de"
          ? "Nürnberg Renegades e.V. - Dein Flag Football Team in Nürnberg. Wir spielen in der 1. DFFL Liga. Probetraining für alle Levels willkommen!"
          : "Nürnberg Renegades e.V. - Your Flag Football Team in Nürnberg. We compete in the 1st DFFL League. Try-outs welcome for all skill levels!"
        }
      />
      <OrganizationSchema />
      ...
      <section className="relative min-h-[85vh] md:h-[90vh] flex items-center justify-center overflow-hidden py-12">
        <div 
          ...
          role="img"
          aria-label="Flag Football field with team players"
        />
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-8 animate-fade-up-delay-1">
            {language === "de" 
              ? "Werde Teil eines der erfolgreichsten Flag Football Teams in Bayern. Training für alle Levels - vom Anfänger bis zum Profi."
              : "Join one of the most successful flag football teams in Bavaria. Training for all levels - from beginner to pro."
            }
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-6">
                {language === "de" 
                  ? "Flag Football ist die kontaktlose Variante des American Football. Statt Tackles werden die Spielzüge durch das Ziehen von Flaggen beendet. Der Sport ist schnell, taktisch anspruchsvoll und für alle Altersgruppen und Fitnesslevel geeignet."
                  : "Flag Football is the non-contact version of American Football. Instead of tackles, plays are stopped by pulling flags. The sport is fast, tactically demanding, and suitable for all ages and fitness levels."
                }
              </p>
              <p className="text-muted-foreground text-lg mb-8">
                {language === "de"
                  ? "Seit 2028 ist Flag Football olympische Disziplin bei den Olympischen Spielen in Los Angeles - ein Sport mit großer Zukunft!"
                  : "Since 2028, Flag Football is an Olympic sport at the Los Angeles Olympics - a sport with a great future!"
                }
              </p>
            ...
            <div className="relative">
              <img 
                src={actionImage}
                alt="Flag Football action shot with players running plays on a green field"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a 
              ...
              aria-label="Visit DFFL Website - Deutsche Flag Football Liga"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <img 
                src={teamHuddleImage}
                alt="Nürnberg Renegades team huddle showing team spirit and unity"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-muted-foreground text-lg mb-6">
                {language === "de"
                  ? "Bei den Nürnberg Renegades geht es um mehr als nur Sport. Wir sind eine Familie, die gemeinsam trainiert, gewinnt und wächst. Unser Team besteht aus Spielern aller Altersgruppen und Hintergründe."
                  : "At Nürnberg Renegades, it's about more than just sports. We're a family that trains, wins, and grows together. Our team consists of players of all ages and backgrounds."
                }
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-muted-foreground">
                    {language === "de" 
                      ...
                      : "Regular team events and group activities"
                    }
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-muted-foreground">
                    {language === "de"
                      ? "Mentoring-Programm für neue Spieler"
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-muted-foreground">
                    {language === "de"
                      ? "Internationale Turniere und Auswärtsfahrten"
                      : "International tournaments and away trips"
                    }
                  </span>
                </li>
              </ul>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-lg text-center max-w-2xl mx-auto mb-12">
            {language === "de"
              ? "Entdecke, was die Nürnberg Renegades besonders macht und warum Spieler aller Levels bei uns trainieren."
              : "Discover what makes Nürnberg Renegades special and why players of all levels train with us."
            }
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <article className="bg-card-gradient rounded-lg p-6 border border-border">
                ...
                <p className="text-muted-foreground mb-4">
                  {language === "de"
                    ? "Unser Trainingsgelände befindet sich zentral in Nürnberg mit guter Anbindung an öffentliche Verkehrsmittel."
                    : "Our training ground is centrally located in Nürnberg with good public transport connections."
                  }
                </p>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
            {language === "de"
              ? "Melde dich für ein kostenloses Probetraining an und erlebe Flag Football hautnah!"
              : "Sign up for a free try-out session and experience flag football firsthand!"
            }
          </p>
